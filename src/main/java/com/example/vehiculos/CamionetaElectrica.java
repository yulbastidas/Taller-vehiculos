...
public class CamionetaElectrica extends Camioneta implements Electrico {
    private int bateria;
    public CamionetaElectrica(String placa, String marca, String modelo, double km, double capacidadCargaKg, int bateriaInicial) {
        super(placa, marca, modelo, km, capacidadCargaKg);
